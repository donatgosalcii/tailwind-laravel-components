    ...
    <div class="bg-white dark:bg-slate-900">
        <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-40">
            <div class="mx-auto max-w-4xl divide-y divide-gray-900/10 dark:divide-white/10">
                <h2 class="text-4xl font-bold leading-10 tracking-tight text-gray-900 dark:text-white">Frequently asked questions</h2>
                ...
                <dl class="mt-10 space-y-6 divide-y divide-gray-900/10 dark:divide-white/10">
                    ...
                    <div x-data="{ open: false }" class="pt-6">
                        ...
                        <dd x-show="open" x-collapse class="mt-2 pr-12">
                            <p class="text-base leading-7 text-gray-600 dark:text-gray-300">I don't know, but the flag is a big plus. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cupiditate laboriosam fugiat.</p>
                        </dd>
                    </div>
